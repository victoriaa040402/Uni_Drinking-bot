...
def round1(players, sips):
    for i in players:
        ...
        if card == "Ace":
            print("Going around the circle clockwise, each player must starts drinking consecutively and has to continue drinking until the one before has stopped")
            sips += len(deck)
            ...
            print("Choose another player to become your 'mate', this player will have to drink each time you have to during the game")
            time.sleep()
...
""")
            ...
            if king =  4:
                ...
                print("you are the ", king, "th king")
    return sips
